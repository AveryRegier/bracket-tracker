 ...
 */
public class MenuNameComparator implements Comparator {
	public static final Comparator INSTANCE = new MenuNameComparator();
	
	public int compare(Object o1, Object o2) {
		if(o1 == o2) return 0;
		if(o1 != null) {
			String name1 = ((MenuItem)o1).getName();
			String name2 = ((MenuItem)o2).getName();
