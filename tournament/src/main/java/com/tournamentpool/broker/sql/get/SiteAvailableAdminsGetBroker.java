 ...
 */
public class SiteAvailableAdminsGetBroker extends PreparedStatementBroker {
	 ...
	 * @param sp
	 */
	public SiteAvailableAdminsGetBroker(SingletonProvider sp) {
		super(sp);
	}

	protected String getSQLKey() {
		return "SiteAdminsAvailableGetSQL";
	}
