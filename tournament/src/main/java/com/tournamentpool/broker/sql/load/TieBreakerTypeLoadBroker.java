 ...
 */
public class TieBreakerTypeLoadBroker extends LoadBroker {

	/**
	 * @param sp
	 */
	public TieBreakerTypeLoadBroker(SingletonProvider sp) {
		super(sp);
	}
	...
	protected void processResults(ResultSet set) throws SQLException {
		while(set.next()) {
			int tieBreakerTypeOID = set.getInt("TIE_BREAKER_TYPE_ID");
			String name = set.getString("NAME");
			sp.getSingleton().getUserManager().loadTieBreakerType(tieBreakerTypeOID, name);
		}
	}
}
