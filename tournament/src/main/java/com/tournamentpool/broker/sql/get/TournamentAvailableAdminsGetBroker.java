 ...
 */
public class TournamentAvailableAdminsGetBroker extends PreparedStatementBroker {
	 ...
	 * @param sp
	 */
	public TournamentAvailableAdminsGetBroker(SingletonProvider sp, MainTournament tournament) {
		super(sp);
		this.tournament = tournament;
	}

	protected String getSQLKey() {
		return "TournamentAdminsAvailableGetSQL";
	}
	...
	protected void processResults(ResultSet set) throws SQLException {
		while(set.next()) {
			if(!tournament.hasAdmin(set.getInt("PLAYER_ID"))) {
