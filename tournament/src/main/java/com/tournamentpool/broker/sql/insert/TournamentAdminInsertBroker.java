 ...
 */
public class TournamentAdminInsertBroker extends InsertBroker {
	 ...
	 * @param name
	 */
	public TournamentAdminInsertBroker(SingletonProvider sp, MainTournament tournament, int adminOID) {
		super(sp);
