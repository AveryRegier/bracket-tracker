...
public class TeamDeleteBroker extends PreparedStatementBroker {
	private final Team team;

	public TeamDeleteBroker(SingletonProvider sp, Team team) {
		super(sp);
		this.team = team;
	}
	...
	protected void processUpdateCount(int updateCount) throws SQLException {
		if(updateCount == 1) {
			sp.getSingleton().getTeamManager().applyDelete(team);
		}
	}
}
