...
public class PlayerDeleteBroker extends PreparedStatementBroker {

	private final User player;
	private final UserManager userManager;

	public PlayerDeleteBroker(SingletonProvider sp, UserManager userManager, User player) {
		super(sp);
