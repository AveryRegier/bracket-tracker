...
<table border="0" cellpadding="0" cellspacing="0" width="60%" align="center">
	<tr class="round-title" valign="top" align="right">
		...
		<td colspan="2" width="100%" background="/images/boxtop.gif">
	...
	<tr valign="top" align="left">
		...
		<td colspan="2" width="100%" background="/images/boxbottom.gif"><img src="/images/boxbottom.gif" alt="" width="9" height="8" border="0"></td>
