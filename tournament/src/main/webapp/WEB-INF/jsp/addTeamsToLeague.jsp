...
<html>
<head>
<title>Add Teams to League <c:out value="${league.name}"/></title>
<link rel="stylesheet" type="text/css" href="/tournament/basic.css">
</head>
<body onLoad="theForm.team.focus()">
...
<table border="0" cellpadding="0" cellspacing="0" width="60%" align="center">
	<tr class="round-title" valign="top" align="right">
		...
		<td width="100%" background="/tournament/images/boxtop.gif">
			<table border="0" cellpadding="2" cellspacing="0" width="100%" align="center">
				<tr>
					<td align="left" valign="top"><b>Add Teams To <c:out value="${league.name}"/><br><!-- title --></b></td>
				</tr>
			</table>
		</td>
	...
	<tr valign="top" align="left">
		...
		<td width="100%">
			...
			<input type="hidden" name="league" value="<c:out value="${league.id}"/>">
			<table cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td class="head" valign="top">Available<br>Teams:</td>
					<td>&nbsp;&nbsp;&nbsp;</td>
					<td class="content">
						<select name="team" size="10" multiple>
				...
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td colspan="3" align="center"><input type="submit" value="Add" class="common">
					<a href="<c:out value="${config.CreateTeamURL}"/>?league=<c:out value="${league.id}"/>">Create New Team</a>
					</td>
				</tr>
			</table>
			</form>
