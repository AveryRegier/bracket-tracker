...
<body onLoad="theForm.fromLeague.focus()">
	...
	<tr class="round-title" valign="top" align="right">
		...
		<td width="100%" background="/images/boxtop.gif">
			<table border="0" cellpadding="2" cellspacing="0" width="100%" align="center">
				<tr>
					<td align="left" valign="top"><b>Select League to Import Teams From<br><!-- title --></b></td>
				</tr>
			</table>
		</td>
	...
	<tr valign="top" align="left">
		...
		<td width="100%">
			...
			<table cellspacing="3" cellpadding="0" border="0">
				...
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td colspan="2" align="center"><input class="common" type="submit" value="Import Teams from this League"></td>
				</tr>
			</table>
			</form>
			<!--Content Table-->
