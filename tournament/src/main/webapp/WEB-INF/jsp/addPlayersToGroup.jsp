...
<html>
<head>
<title>Add Players to Group <c:out value="${Group.name}"/></title>
...
<table border="0" cellpadding="0" cellspacing="0" width="60%" align="center">
	<tr class="round-title" valign="top" align="right">
		...
		<td width="100%" background="/images/boxtop.gif">
			<table border="0" cellpadding="2" cellspacing="0" width="100%" align="center">
				<tr>
					<td align="left" valign="top"><b>Add Players To <c:out value="${Group.name}"/> Group<br><!-- title --></b></td>
				</tr>
			</table>
		</td>
	...
	<tr valign="top" align="left">
		...
		<td width="100%">
			...
			<input type="hidden" name="group" value="<c:out value="${Group.oid}"/>">
