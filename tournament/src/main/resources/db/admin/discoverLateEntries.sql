...
FROM
(SELECT U.PLAYER_ID, U.NAME AS PLAYER_NAME, G.GROUP_ID, G.NAME AS GROUP_NAME, G.PROGENITOR_GROUP_ID, P.POOL_ID, P.NAME AS POOL_NAME, B.BRACKET_ID, B.TOURNAMENT_ID, B.NAME, BRACKET_COUNT.NUM_PICKS
FROM 
...
WHERE BP.BRACKET_ID IS NULL AND POSSIBLE.NUM_PICKS = 63
) FOO );
