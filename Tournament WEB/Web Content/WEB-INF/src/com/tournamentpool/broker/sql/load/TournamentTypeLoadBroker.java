 ...
 */
public class TournamentTypeLoadBroker extends LoadBroker {

	/**
	 * @param sp
	 */
	public TournamentTypeLoadBroker(SingletonProvider sp) {
		super(sp);
	}
	...
	protected void processResults(ResultSet set) throws SQLException {
		while(set.next()) {
			...
			int gameNodeOID = set.getInt("LAST_GAME_NODE_ID");
			sp.getSingleton().getTournamentTypeManager().loadTournamentType(tournamentTypeOID, name, gameNodeOID);
		}
	}
