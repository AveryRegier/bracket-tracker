...
public class BracketDeleteBroker extends PreparedStatementBroker {

	private final Bracket bracket;

	public BracketDeleteBroker(SingletonProvider sp, Bracket bracket) {
		super(sp);
		this.bracket = bracket;
	}

	protected String getSQLKey() {
		return "BracketDeleteSQL";
	}
