...
public class LeagueTeamDeleteBroker extends PreparedStatementBroker {

	private final Team team;
	private final League league;

	public LeagueTeamDeleteBroker(SingletonProvider sp, League league,  Team team) {
		super(sp);
		this.league = league;
		this.team = team;
	}
