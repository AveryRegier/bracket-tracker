 ...
 */
public class LeagueInsertBroker extends InsertBroker {

	private final String name;
	private int oid;

	public LeagueInsertBroker(SingletonProvider sp, String name) {
		super(sp);
		this.name = name;
	}
			...
			throws SQLException 
	{
		while(generated.next()) {
			...
			sp.getSingleton().getTeamManager().loadLeague(
				oid,
				name
			);
		}
