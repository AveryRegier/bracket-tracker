 ...
 */
public class SeedLoadBroker extends LoadBroker {

	/**
	 * @param sp
	 */
	public SeedLoadBroker(SingletonProvider sp) {
		super(sp);
	}
	...
	protected void processResults(ResultSet set) throws SQLException {
		while(set.next()) {
			...
			int seedNo = set.getInt("SEED_NO");
			sp.getSingleton().getTournamentTypeManager().loadSeed(
				seedOID, tournamentTypeOID, seedNo
			);
		}
	}
