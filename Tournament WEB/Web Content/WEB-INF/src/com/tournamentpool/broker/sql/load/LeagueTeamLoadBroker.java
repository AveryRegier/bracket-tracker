 ...
 * @author Avery Regier 
 */
public class LeagueTeamLoadBroker extends LoadBroker {

	/**
	 * @param sp
	 */
	public LeagueTeamLoadBroker(SingletonProvider sp) {
		super(sp);
	}
	...
	protected void processResults(ResultSet set) throws SQLException {
		while(set.next()) {
			...
			sp.getSingleton().getTeamManager().loadLeagueTeamAssociation(leagueOID, teamOID);
		}
	}
}
