...
<html>
<head>
<title>Select Start Level for a new Sub Tournament</title>
	...
	<tr class="round-title" valign="top" align="right">
		...
		<td width="100%" background="/tournament/images/boxtop.gif">
			<table border="0" cellpadding="2" cellspacing="0" width="100%" align="center">
				<tr>
					<td align="left" valign="top"><b>Select Start Level for a new Sub Tournament<br><!-- title --></b></td>
				</tr>
			</table>
		</td>
		...
		<td width="100%">
			...
			<table cellspacing="3" cellpadding="0" border="0">
				...
				<tr>
					...
					<td class="content">
						<select name="level">
							<c:forEach var="item" items="${levels.items}">
				...
				<tr><td>&nbsp;</td></tr>
				<tr>
					<td colspan="2" align="center"><input class="common" type="submit" value="Create Sub Tournament"></td>
				</tr>
			</table>
			</form>
			<!--Content Table-->
